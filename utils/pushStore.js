...
const WIN_STREAK_TEXTS = {
  3: '🎉🔥 {count} 连胜！手感彻底热起来了，趁热再来一把',
  4: '🔥🔥 {count} 连胜！已经可以开始挑对手了',
  5: '⚡ {count} 连胜！对面要开始查战绩了',
  6: '⚡🔥 {count} 连胜！一个人把全队胜率抬起来了',
  7: '🚀 {count} 连胜！这是要打穿一整个赛季',
  8: '🚀✨ {count} 连胜！排到一队的都在偷偷道谢',
  9: '👑 {count} 连胜！再赢一把就上两位数了',
  10: '👑🎉 {count} 连胜达成！建议直接开个直播',
  11: '🏆 {count} 连胜！已经开始不讲道理了',
  12: '🏆🔥 {count} 连胜！对面选人阶段看到就想投',
  13: '💫 {count} 连胜！这把要是输了都算大新闻',
  14: '💫👑 {count} 连胜！峡谷公告栏该挂个名了',
  15: '🌟 {count} 连胜！已经是本群传说了',
  16: '🌟🔥 {count} 连胜！胜率曲线开始垂直向上',
  17: '🐉 {count} 连胜！这已经不是上分，是搬家',
  18: '🐉✨ {count} 连胜！再来两把该被写进史书了',
  19: '🎖️ {count} 连胜！距离二十连只差一口气',
  20: '🎖️👑 {count} 连胜！不是在打游戏，是在巡视领地'
}

/** 连败逐场文案，规则同上（不写名字、不写模式名）。语气要泄气但不能真扎人，群里被推的是本人 */
const LOSE_STREAK_TEXTS = {
  3: '😮‍💨🧊 {count} 连败，先去喝口水，下一把稳住',
  4: '🧊🧊 {count} 连败，换个英雄试试运气',
  5: '☕ {count} 连败，认真的，歇一把再打',
  6: '☕😵 {count} 连败，今天大概不是上分的日子',
  7: '🌧️ {count} 连败，峡谷欠一个正式道歉',
  8: '🌧️😮‍💨 {count} 连败，系统怕是安排了一路扶贫',
  9: '🛌 {count} 连败，下线睡觉才是最优解',
  10: '🛌💤 {count} 连败达成，明天再战一点都不丢人',
  11: '🕳️ {count} 连败，分数正在自由落体',
  12: '🕳️😭 {count} 连败，这是在挖隧道吗',
  13: '🆘 {count} 连败，群里有人愿意来救一下吗',
  14: '🆘🧊 {count} 连败，强烈建议今天到此为止',
  15: '⚰️ {count} 连败，峡谷已经降半旗了',
  16: '⚰️😵 {count} 连败，还在坚持，这份毅力值得敬礼',
  17: '🌑 {count} 连败，运气应该已经见底了',
  18: '🌑😔 {count} 连败，真的不用再证明什么了',
  19: '🧯 {count} 连败，谁去把手机没收一下',
  20: '🧯🪦 {count} 连败，今天这一串就当没发生过'
}
...
/**
 * 挑出这一档的文案并填好场次。
 * `{who}` 仍然支持替换，但现在所有文案都不用它（名字由消息开头那段负责，见 WIN_STREAK_TEXTS 注释）。
 */
