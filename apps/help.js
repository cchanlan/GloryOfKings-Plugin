...
const helpSections = [
  ...
  },
  {
    ...
    list: [
      ...
      { cmd: '#全部王者主页', desc: '查看已绑定全部营地ID的主页' },
      { cmd: '#查询战绩', args: '[排位/巅峰] [序号]', desc: '查询近期对局战绩' },
      { cmd: '#查英雄战绩', args: '[英雄名]', desc: '查询指定英雄的近期战绩' },
      { cmd: '#查询N战绩', args: '[排位/巅峰] [序号]', desc: '查询第N个绑定ID的战绩' },
      { cmd: '#排位表现', args: '[营地ID]', desc: '查看排位赛表现数据' },
      { cmd: '#巅峰表现', args: '[营地ID]', desc: '查看巅峰赛表现数据' },
      { cmd: '#常用英雄', alias: ['#我的英雄', '#英雄战力榜'], desc: '查看常用英雄战力' },
